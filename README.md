...
](https://github.com/rai-project/goreleaser/releases)
...
Would you like to fix something in the documentation? Feel free to open an [issue](https://github.com/rai-project/goreleaser/issues).
